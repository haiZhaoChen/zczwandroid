...
public class TagGridViewAdapter extends BaseAdapter {
    ...
    public TagGridViewAdapter(List<User> groupMemberList, Context context){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.name = (TextView) convertView.findViewById(R.id.name_tag_item);
            viewHolder.img = (ImageView) convertView.findViewById(R.id.img_tag_item);
        ...
        switch (user.getUsername()){
            ...
            default:
                ...
                if (!TextUtils.isEmpty(list.get(position).getImagePosition()) && list.get(position).getImagePosition().length()>10) {
                    Picasso.with(context).load(list.get(position).getImagePosition()).into(viewHolder.img);
                }
                break;
        }
        return convertView;
