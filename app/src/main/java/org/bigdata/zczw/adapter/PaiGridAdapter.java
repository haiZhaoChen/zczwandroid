...
public class PaiGridAdapter extends BaseAdapter {
    ...
    public PaiGridAdapter(Context ctx, List<String> imageUrls) {
        this.ctx = ctx;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Picasso.with(ctx).load(imageUrls.get(position)).resize(300,300).centerCrop().into(imageView);
