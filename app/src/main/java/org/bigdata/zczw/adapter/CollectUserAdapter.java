 ...
 */
public class CollectUserAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private List<CollectUser> praiseUserList;
    private Context context;

    public CollectUserAdapter(Context context, List<CollectUser> praiseUserList){
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        holder.time.setText(DateUtils.convertToDate(praiseUserList.get(position).getCollectTime()));
