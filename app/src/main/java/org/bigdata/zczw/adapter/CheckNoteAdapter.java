...
public class CheckNoteAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<CheckNote> checkNoteList;

    public CheckNoteAdapter(Context context, ArrayList<CheckNote> checkNoteList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.check_notes_item,null);
