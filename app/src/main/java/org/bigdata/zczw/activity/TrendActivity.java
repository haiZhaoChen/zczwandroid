    ...
    private void initView() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(TrendActivity.this,MessageActivity.class);
    ...
    public void onRefresh(PullToRefreshBase<ListView> refreshView) {
        ...
        if (refreshView.isShownFooter()) {
            ...
            if (zanList != null && zanList.size()>0) {
                ...
                Utils.showToast(TrendActivity.this,"没有更多消息");
            }
        }
    }
    ...
    private RequestCallBack<String> zanCallBack = new RequestCallBack<String>() {
        ...
        public void onSuccess(ResponseInfo<String> responseInfo) {
            ...
            if (zanBean != null && zanBean.getStatus() == 200) {
                ...
                trendAdapter = new TrendAdapter(TrendActivity.this,zanList,2);
